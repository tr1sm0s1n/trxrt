...
func HomeScreen(_ fyne.Window) fyne.CanvasObject {
	...
	footer := container.NewHBox(
		layout.NewSpacer(),
		widget.NewHyperlink("GitHub", parseURL("https://github.com/tr1sm0s1n")),
		widget.NewLabel("-"),
		widget.NewHyperlink("LinkedIn", parseURL("https://linkedin.com/in/tr1sm0s1n/")),
		layout.NewSpacer(),
	)
	...
	return container.NewStack(container.New(unpad{top: true},
		// bgClip,
		bg),
